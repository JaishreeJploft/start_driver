...
// import 'package:newadminappmohammad/constant/color_constant.dart';
// import '../intl/src/intl/date_format.dart';
//
//
// // Examples can assume:
...
//           isShowdate?Container(child: Text("${DateFormat('EEEE, dd MMM yyyy').format(DateTime.now())}",style: TextStyle(color: ColorConstants.primaryColor,fontWeight: FontWeight.w700,fontSize: 18),),alignment: Alignment.center,):SizedBox.shrink(),
//         ],
//       ),
//     );
//   }
...
//       child: Text(
//         text,
//         style: style.copyWith(color: ColorConstants.primaryColor,fontSize: 24,fontWeight: FontWeight.w400),
//       ),
//     );
//   }
// }
...
//         style: hourMinuteStyle.apply(color: ColorConstants.primaryColor),
//         textScaleFactor: 0.3,
//       ),
//     );
//   }
...
//           padding: orientation == Orientation.portrait ? EdgeInsets.only(left: 50.0, right: 40.0, bottom: 0.0, top: 10.0) : const EdgeInsets.all(24),
...
import 'package:stardriver/common/intl/src/intl/date_format.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          controls,
          isShowdate?const SizedBox(height: 30,child: VerticalDivider(thickness: 1,width: 1,),):const SizedBox.shrink(),
          isShowdate?Container(alignment: Alignment.center,child: Text(DateFormat('EEEE, dd MMM yyyy').format(DateTime.now()),style: TextStyle(color: ColorConstants.primaryColor,fontWeight: FontWeight.w700,fontSize: 15.sp),),):const SizedBox.shrink(),
        ],
      ),
    );
  }
...
class _HourMinuteControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Text(
        text,
        style: style.copyWith(color: ColorConstants.primaryColor,fontSize: 20.sp,fontWeight: FontWeight.w400),
      ),
    );
  }
}
    ...
    final Widget amButton = InkWell(
      ...
      child: Semantics(
        ...
        child: Center(
          child: Text(
            materialLocalizations.anteMeridiemAbbreviation,
            style: TextStyle(color: amSelected?const Color(0xFF000000):const Color(0xFFD1D1D1)),
            textScaleFactor: 0.6,
          ),
        ),
      ),
    ...
    final Widget pmButton = InkWell(
      ...
      child: Semantics(
        ...
        child: Center(
          child: Text(
            materialLocalizations.postMeridiemAbbreviation,
            style: TextStyle(color: pmSelected?const Color(0xFF000000):const Color(0xFFD1D1D1)),
            textScaleFactor: 0.6,
          ),
        ),
      ),
...
class _TimePickerDialogsState extends State<TimePickerDialogs> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    switch (_entryMode.value) {
      ...
      case TimePickerEntryMode.dialOnly:
        final Widget dial = Padding(
          padding: orientation == Orientation.portrait ? const EdgeInsets.only(left: 50.0, right: 40.0, bottom: 0.0, top: 10.0) : const EdgeInsets.all(24),
          child: ExcludeSemantics(
            child: AspectRatio(
              aspectRatio: 1.0,
              child: Card(
