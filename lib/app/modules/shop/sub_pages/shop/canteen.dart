...
class Canteen extends GetView<ShopInternalController>{
        ...
        children: [
          ...
          Expanded(
              child: GridView.builder(
                itemCount: controller.canteenImageList.length,
                shrinkWrap: true,
                      ...
                      child: Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              controller.canteenImageList[index],
                              height: 20.h,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          const Icon(Icons.add,color: ColorConstants.primaryColor,),
                                          addText('Add', getSmallTextFontSIze(), ColorConstants.primaryColor, FontWeight.bold)
