...
class CanteenOrderWeekView extends GetView<OrdersController>{
  const CanteenOrderWeekView({super.key,this.type});
  ...
  Widget buildComplainList(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return type == 0 ? buildThisWeek(index) : buildEveryWeek(index);
      },
    );
  }

  buildThisWeek(int index){
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  // buildInfoItems('Serving Days', "Monday, Tuesday, Wednesday, Thursday"),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: addText('Cancel', getSmallTextFontSIze(),
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              addText('Serving Days', getSmallTextFontSIze()+1, ColorConstants.black,
                  FontWeight.normal),

              Expanded(
                child: addText(' : Monday, Tuesday, Wednesday', getSmallTextFontSIze()+1, ColorConstants.primaryColor,
                    FontWeight.bold),
              ),
          ...
          StepProgressView(width: 100.w,
              curStep: 4,
              statuses: const ["Order\nPlaced", "Confirmed", "Served"],
          ...
          Row(
            children: [
              Column(
                ...
                children: [
                  buildInfoItems('Order Id', '#45689'),
                  buildInfoItems('Order Type', 'Schedule'),
                  buildInfoItems('Order Date', '28/06/2023'),
                ],
              ),
              const Spacer(),
