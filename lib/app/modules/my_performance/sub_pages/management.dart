...
class Management extends GetView<PerformanceController> {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () async {
                          controller.managementFilterSelectedPos.value = index;
                        },
                        child: Obx(
                          () => Container(
                            ...
                            decoration: BoxDecoration(
                                color: controller.managementFilterSelectedPos
                                            .value ==
                                        index
                                    ? ColorConstants.primaryColorLight
                                    : ColorConstants.white,
                                boxShadow: controller
                                            .managementFilterSelectedPos
                                            .value ==
                                        index
                                    ? [getDeepBoxShadow()]
                                    : null,
                                border: controller.managementFilterSelectedPos
                                            .value ==
                                        index
                                    ? Border.all(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(
                  ...
                  message: 'Performance is not good, he dont know how to talk and drive bus. Management is also very poor',
          ...
          Row(
            children: [
              ...
              addText('(Head Master)', getSmallTextFontSIze(),
