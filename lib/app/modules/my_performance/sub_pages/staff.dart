...
class Staff extends GetView<PerformanceController> {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () async {
                          controller.staffFilterSelectedPos.value = index;
                        },
                        child: Obx(
                          () => Container(
                            ...
                            decoration: BoxDecoration(
                                color: controller
                                            .staffFilterSelectedPos.value ==
                                        index
                                    ? ColorConstants.primaryColorLight
                                    : ColorConstants.white,
                                boxShadow:
                                    controller.staffFilterSelectedPos.value ==
                                            index
                                        ? [getDeepBoxShadow()]
                                        : null,
                                border:
        ...
        children: [
          ...
          Row(
            children: [
              ...
              addText('(Maths Teacher)', getSmallTextFontSIze(),
