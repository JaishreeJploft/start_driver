...
class PlannedMeeting extends GetView<ScheduleMeetingController>{
  const PlannedMeeting({super.key});
            ...
            children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                          child: addText('Start', getSmallTextFontSIze(),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  itemCount: controller.planningList.length,
                    ...
                    return Obx(() => GestureDetector (
                      onTap: (){
                        if(index == 0){
                          ...
                          controller.selectedPlanningPos.value = index;
                        }
                      },
                      child: Container(
                        height: 4.h,
                        ...
                        decoration: controller.selectedPlanningPos.value == index ? getPrimaryDecoration() : getEditTextDecoration(),
                        child: Center(child: addText(controller.planningList[index],getSmallTextFontSIze(), controller.selectedPlanningPos.value == index ? ColorConstants.primaryColor : ColorConstants.borderColor, FontWeight.normal)),
                      ),
                    ));
                  },
                ),
