...
class Absent extends GetView<TripOperationController>{
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Column(
                children: [
                  addText('ABSENT', getSmallTextFontSIze(), Colors.redAccent, FontWeight.bold),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildInfoItems('Current Status' , 'Absent'),
              ListView.builder(
